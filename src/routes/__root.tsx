...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PeerDrop — Instant peer-to-peer file sharing" },
      { name: "description", content: "Send files between devices through your browser. No uploads. WebRTC + QR pairing." },
      { name: "author", content: "PeerDrop" },
